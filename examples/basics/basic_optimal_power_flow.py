...
v, pf, p_gens, q_gens = case.run_opf("loss_min", control_variable="PQ")
...
plot_gens(p_gens, q_gens).show(renderer="browser")
plot_polar(p_gens, q_gens).show(renderer="browser")
