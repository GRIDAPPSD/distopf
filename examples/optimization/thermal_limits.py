...
case.branch_data["s_a_max"] = np.nan
case.branch_data["s_b_max"] = np.nan
case.branch_data["s_c_max"] = np.nan
...
case.branch_data.loc[case.branch_data.tb == 2, ["s_a_max", "s_b_max", "s_c_max"]] = (
    1.205 * 1.0823921
)
print(case.branch_data.head())
results = case.run_opf(objective, control_variable=control_variable, wrapper=wrapper)
