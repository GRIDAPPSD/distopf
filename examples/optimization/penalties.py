    ...
    branch_data = pd.DataFrame(
        {
            ...
            "r_aa": [0.01, 0.01, 0.01],
            "x_aa": [0.02, 0.02, 0.02],
            "r_ab": [0.001, 0.001, 0.001],
            "x_ab": [0.002, 0.002, 0.002],
            "r_ac": [0.001, 0.001, 0.001],
            "x_ac": [0.002, 0.002, 0.002],
            "r_bb": [0.01, 0.01, 0.01],
            "x_bb": [0.02, 0.02, 0.02],
            "r_bc": [0.001, 0.001, 0.001],
            "x_bc": [0.002, 0.002, 0.002],
            "r_cc": [0.01, 0.01, 0.01],
            "x_cc": [0.02, 0.02, 0.02],
            "s_a_max": [1.0, 1.0, 1.0],  # MVA thermal limits
            "s_b_max": [1.0, 1.0, 1.0],
            "s_c_max": [1.0, 1.0, 1.0],
        }
    )
    ...
    gen_data = pd.DataFrame(
        {
            ...
            "name": ["gen1"],
            "phases": ["abc"],
            "p_a": [0.4],  # MW available
            "p_b": [0.4],
            "p_c": [0.4],
            "q_a": [0.0],
            "q_b": [0.0],
            "q_c": [0.0],
            "s_a_max": [0.5],  # MVA rating
            "s_b_max": [0.5],
            "s_c_max": [0.5],
            "q_a_max": [0.3],
            "q_b_max": [0.3],
