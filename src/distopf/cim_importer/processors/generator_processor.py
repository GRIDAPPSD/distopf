...
class GeneratorProcessor(BaseProcessor):
    ...
    def _process_power_electronics_connection(self, pec) -> dict | None:
        ...
        # else:
        #     gen_data["p_a"] = gen_data["p_b"] = gen_data["p_c"] = total_p_pu / 3.0
        #     gen_data["q_a"] = gen_data["q_b"] = gen_data["q_c"] = total_q_pu / 3.0
        #     gen_data["phases"] = "abc"
